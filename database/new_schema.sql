...
-- Table de liaison entre challenges et technologies
...
-- Table des participants au hackathon
...
-- Script de migration (à titre d'exemple)
-- Migrer de l'ancienne table users vers la nouvelle
/*
