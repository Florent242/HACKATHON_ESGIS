...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/HACKATHON_ESGIS/public/css/styles/user/challenge.css">
        ...
        <!-- Lucide Icons CLI & CDN -->
        <script defer src="/HACKATHON_ESGIS/public/js/user/challenge.js"></script>
