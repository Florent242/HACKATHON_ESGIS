...
<head>
    ...
    <!-- CSS personnalisé -->
    <link rel="stylesheet" href="/css/styles/admin/leaderboard.css">
    <?php require_once '../includes/admin/head.php'; ?>

    <!-- JavaScript personnalisé -->
    <script defer src="/js/admin/leaderboard.js"></script>
        ...
        <div class="bg-blue-950/40 rounded-xl p-5 border border-blue-800/30 mb-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div class="mt-4 flex flex-wrap gap-3">
                    <button id="qualify-teams"
                        class="px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg text-sm font-medium flex items-center gap-2 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                        <i data-lucide="check-circle" class="w-4 h-4"></i>
                        Qualifier les équipes
                    </button>
                    <button id="freeze-phase"
                        class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm font-medium flex items-center gap-2 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                        <i data-lucide="snowflake" class="w-4 h-4"></i>
                        Geler la phase
                    </button>
                    <button id="unfreeze-phase"
                        class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm font-medium flex items-center gap-2 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                        <i data-lucide="snowflake" class="w-4 h-4"></i>
                        Dégeler la phase
