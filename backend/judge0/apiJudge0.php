...
try {
    ...
    $baseDir = __DIR__;
    require_once $baseDir . '/Judge0Request.php';
    require_once $baseDir . '/Judge0Executor.php';
    require_once $baseDir . '/Judge0Response.php';

    // Créer et exécuter la requête
    $request = new Judge0\Judge0Request(
        $input['language'],
        $input['code'],
        $input['version']
    );

    $executor = new Judge0\Judge0Executor();
